export const translations = {
  en: {
    ...
    hero: {
      ...
      desc: "Authorized E-Registry Provider in Sagar. We provide expert consultancy for property registration, sell deeds, and legal documentation with the Department of Registration and Stamps.",
  ...
  hi: {
    ...
    hero: {
      ...
      desc: "सागर में अधिकृत ई-रजिस्ट्री प्रदाता। हम पंजीकरण और मुद्रांक विभाग के साथ संपत्ति पंजीकरण, बिक्री विलेख और कानूनी दस्तावेजों के लिए विशेषज्ञ परामर्श प्रदान करते हैं।",
