export const translations = {
  en: {
    nav: {
      ...
      licenseItems: ["Shop Act", "Trade License", "FSSAI License", "Udyam Reg."],
      registrationItems: ["Property Registry", "Firm Registration", "Marriage Reg.", "Trust/Society"],
      contact: "CONTACT US",
      callNow: "CALL NOW",
    },
    hero: {
  ...
  hi: {
    nav: {
      ...
      licenseItems: ["गुमास्ता (Shop Act)", "व्यापार लाइसेंस", "खाद्य लाइसेंस", "उद्यम पंजीकरण"],
      registrationItems: ["प्रॉपर्टी रजिस्ट्री", "फर्म पंजीकरण", "विवाह पंजीकरण", "ट्रस्ट/सोसायटी"],
      contact: "संपर्क करें",
